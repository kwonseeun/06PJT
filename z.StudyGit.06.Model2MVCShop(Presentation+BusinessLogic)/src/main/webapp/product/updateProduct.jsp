...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 13px;">
				...
				<tr>
					<td width="105">
						<input 	type="text" name="prodName" class="ct_input_g" 
										style="width: 100px; height: 19px" maxLength="20" value="상품명">
					</td>
				</tr>
			</table>
		</td>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="text" name="prodDetail" value="상세정보" class="ct_input_g" 
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="text" readonly="readonly" name="manuDate" value="20210413" 	
